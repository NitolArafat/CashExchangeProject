...
<head>
  ...
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{ asset('/') }}back-end/css/ionicons.min.css">
  <!-- Theme style -->
  ...
  <link rel="stylesheet" href="{{ asset('/') }}back-end/css/bootstrap3-wysihtml5.min.css">
...
<!-- Bootstrap WYSIHTML5 -->
<script src="{{ asset('/') }}back-end/js/bootstrap3-wysihtml5.all.min.js"></script>
<!-- Slimscroll -->
...
<script src="{{ asset('/') }}back-end/js/pages/dashboard.js"></script>
